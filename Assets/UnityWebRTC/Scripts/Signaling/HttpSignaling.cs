    ...
    public class HttpSignaling : ISignaling
    {
        ...
        private bool HTTPConnect()
        {
            HttpWebRequest request =
                (HttpWebRequest)WebRequest.Create($"{m_url}/connection");
            request.Method = "PUT";
            request.ContentType = "application/json";
            request.Headers.Add("Session-Id", m_sessionId);
            request.KeepAlive = false;
        ...
        {
            Debug.Log($"{m_url}/offer");
            HttpWebRequest request =
                (HttpWebRequest)WebRequest.Create($"{m_url}/offer");
            request.Method = "POST";
            request.ContentType = "application/json";
            //request.Headers.Add("Session-Id", m_sessionId);
            request.KeepAlive = false;
        ...
        {
            Debug.Log($"{m_url}/answer");
            HttpWebRequest request =
                (HttpWebRequest)WebRequest.Create($"{m_url}/answer");
            request.Method = "POST";
            request.ContentType = "application/json";
            //request.Headers.Add("Session-Id", m_sessionId);
            request.KeepAlive = false;
        ...
        {
            Debug.Log($"{m_url}/candidate");
            HttpWebRequest request =
                (HttpWebRequest)WebRequest.Create($"{m_url}/candidate");
            request.Method = "GET";
            request.ContentType = "application/json";
            //request.Headers.Add("Session-Id", m_sessionId);
            request.KeepAlive = false;
